...
Оплата: USDT (TRC-20), Bitcoin. Сначала согласовываем наличие и стоимость, после подтверждения клиента — оплата.
...
Payment: USDT (TRC-20), Bitcoin. We agree on availability and price first, then the client pays.
