...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // 2. Handle button clicks (Inline Keyboard)
      ...
      if (data === 'conditions') {
        const conditionsText = `✦ <b>Условия Secret Travel</b> ✦\n\n• Бронируем отели и авто за <b>60%</b> от цены (65-70% для срочных/горячих направлений).\n• Авиабилеты — за <b>50%</b>.\n• Работаем по 100% предоплате.\n• Оплата принимается в крипте: USDT (TRC-20) или Bitcoin.\n• В случае отмены брони гарантируем полный возврат средств на ваш кошелёк.\n\n<i>Оставьте заявку на сайте или напишите менеджеру напрямую.</i>`;
