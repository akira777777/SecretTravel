...
(() => {
  ...
  const I18N = {
    ru: {
      ...
      'chat.r.prices': '* отели — 60% от кассы<br>* 65% — Чехия, Сербия, Польша, Грузия, Турция<br>* 70% день в день по этим направлениям<br>* авиа — 50%<br>* экскурсии — 50%, авто — 60%<br>* минималка — 12 000 ₽ ($130)<br>* лимит брони — $7,000',
      'chat.r.payment': 'USDT (TRC-20 / ERC-20), Bitcoin. 100% предоплата. адрес кошелька пришлём после подтверждения.',
    ...
    en: {
      ...
      'chat.chip.contact': 'Telegram',
      'chat.r.prices': '* hotels — 60% of rack rate<br>* 65% — Czechia, Serbia, Poland, Georgia, Turkey<br>* 70% same-day on those<br>* flights — 50%<br>* tours — 50%, cars — 60%<br>* minimum — $130 (₽12,000)<br>* per-booking limit — $7,000',
      'chat.r.payment': 'USDT (TRC-20 / ERC-20), Bitcoin. 100% prepayment. wallet sent after you confirm.',
